 ...
 * @author HP745 G3
 */
public class add_grade extends javax.swing.JFrame {

    /**
     * Creates new form add_grade
     */
    public add_grade() {
        initComponents();
    }
...
try {
    ...
    // Ensure grades are between 1.0 and 5.0 and not whole numbers
    ...
    pstmt.setString(2, courseIdText);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(add_grade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
