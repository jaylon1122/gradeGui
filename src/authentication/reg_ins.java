...
public class reg_ins extends javax.swing.JFrame {
   ...
   private boolean isEmailValid(String email) {
    ...
    private void initComponents() {
        ...
        jPanel1.add(cn, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 380, 230, 60));
        ...
        jPanel1.add(lname, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 230, 230, 60));
        ...
        jPanel1.add(em, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 310, 230, 60));
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 460, 50, -1));
        ...
        jPanel1.add(register, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 330, 80, 30));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 330, 90, 30));
        ...
        jLabel6.setText("Choose a Secirity Question");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 140, -1, -1));
        ...
        jPanel1.add(sq, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 160, 210, 60));
        ...
        jPanel1.add(ans, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 240, 230, 60));
 ...
 try {
    ...
    if (username.getText().isEmpty() || fname.getText().isEmpty() || lname.getText().isEmpty() ||
        em.getText().isEmpty() || cn.getText().isEmpty() || pass.getText().isEmpty() || ans.getText().isEmpty()) {
    ...
    } else if (sq.getSelectedIndex() == 0) {
        JOptionPane.showMessageDialog(null, "Please select a Security Question!!");
    } else if (db.insertData("INSERT INTO tbl_users (username, fname, lname, email, contact, type, pass, status, security_question, answer) " +
            "VALUES ('" + username.getText() + "', '" + fname.getText() + "', '" + lname.getText() + "', '" +
            em.getText() + "', '" + cn.getText() + "', '" + ut.getSelectedItem() + "', '" + hashedPassword + "', 'Pending', '" +
            sq.getSelectedItem() + "', '" + hashedAnswer + "')") == 1) {
